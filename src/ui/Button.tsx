...
function Button({
  ...
  const base =
    "whitespace-nowrap text-sm inline-block cursor-pointer rounded-full bg-yellow-400  font-semibold tracking-wide text-stone-800 uppercase transition-colors duration-300 hover:bg-yellow-300 focus:bg-yellow-300 focus:ring focus:ring-yellow-300 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed" +
    " ";

  const styles = {
    primary: base + "px-4 py-2 sm:py-1.5 md:px-6 md:py-3 ",
    secondary:
